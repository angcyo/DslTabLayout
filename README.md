...
```kotlin
dependencies {
    implementation 'com.github.angcyo.DslTablayout:TabLayout:3.0.4'

    //可选
    implementation 'com.github.angcyo.DslTablayout:ViewPager1Delegate:3.0.4'
    //可选
    implementation 'com.github.angcyo.DslTablayout:ViewPager2Delegate:3.0.4'
}
```
